...
class _DatePickerDialogState extends State<DatePickerDialog> with RestorationMixin {
  ...
  void handleChangeButton (DateTime? date){

    if(date == null || date.year == 0 ){
      setState(() {
        _selectedDate.value = null;
      });
      // _selectedDate.value = DateTime(0);
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        Text(_selectedDate.value == null || _selectedDate.value!.year ==  DateTime.parse("0000-01-01 00:00:00.000").year? 'No Date' : formatShortDate(_selectedDate.value!)),
                      ],
                    ),
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(
                            child: ElevatedButton(
                              onPressed: () {
                                handleChangeButton(DateTime.now());
                              },
                              style: const ButtonStyle(
                                // backgroundColor:
                                //     WidgetStatePropertyAll(
