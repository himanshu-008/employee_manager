...
class EmployeeEditPage extends StatefulWidget {
    var argument;
    EmployeeEditPage({super.key,this.argument});
...
class _EmployeeEditPageState extends State<EmployeeEditPage> {
  ...
  void initState() {
    ...
    employeeRole.text = widget.argument.role;
    employeeName.text = widget.argument.name;
    addDate.text = formatShortDate(widget.argument.startDate);
    endDate.text = formatShortDate(widget.argument.endDAte);
    _startDate = widget.argument.startDate;
    _endDate = widget.argument.endDAte;
